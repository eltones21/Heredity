...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] is None:
            ...
            probability *= gene_numb_prop * trait_prob
        else:
            ...
            if gene_number == 0:
                ...
                probability *=  percentages[father] * percentages[mother]
    ...
    for person in probabilities:
        for type in ["gene", "trait"]:
            ...
            for category in probabilities[person][type]:
                val = probabilities[person][type][category] 
                probabilities[person][type][category]  = val / total
